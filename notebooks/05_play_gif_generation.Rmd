...
# Reading files
team_a_tracking <- read.csv("../data/derived/filtered_tracking_ab.csv")
#team_c_tracking <- read.csv("ip_filtered_tracking_cd_500.csv")
team_c_tracking <- read.csv("../data/derived/filtered_tracking_cd.csv")
team_e_tracking <- read.csv("../data/derived/filtered_tracking_ef.csv")
